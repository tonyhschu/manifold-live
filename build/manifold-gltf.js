...
exports.EXTManifold = exports.ManifoldPrimitive = void 0;
const core_1 = require("@gltf-transform/core");
const NAME = "EXT_mesh_manifold";
const MERGE = "MERGE";
class ManifoldPrimitive extends core_1.ExtensionProperty {
    init() {
        ManifoldPrimitive.EXTENSION_NAME = NAME;
        this.propertyType = "ManifoldPrimitive";
        this.parentTypes = [core_1.PropertyType.MESH];
    }
    getDefaults() {
...
exports.ManifoldPrimitive = ManifoldPrimitive;
ManifoldPrimitive.EXTENSION_NAME = NAME;
class EXTManifold extends core_1.Extension {
    constructor() {
        super(...arguments);
        this.extensionName = NAME;
        this.prewriteTypes = [core_1.PropertyType.ACCESSOR];
    }
    ...
    prewrite(context) {
        this.document
            ...
            context.addAccessorToUsageGroup(indices, core_1.WriterContext.BufferViewUsage.ELEMENT_ARRAY_BUFFER);
...
exports.EXTManifold = EXTManifold;
EXTManifold.EXTENSION_NAME = NAME;
